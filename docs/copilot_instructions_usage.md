...
- Grammar: "Using the rules in docs/copilot*instructions.md, draft a `.pgram` for simple arithmetic: headers set, `*`whitespace, drop/inline punctuation, keep identifiers/numbers with`$`."

...
using Parseidon.Cli.TextMateGrammar;
...
public class TextMateGrammarVisitor : INodeVisitor
{
    ...
    private class CreateCodeVisitorContext
    {
        ...
        internal TextMateGrammar.Grammar? Grammar { get; set; }
        internal MessageContext MessageContext { get; set; }
    }

    private class CreateCodeVisitResult : IVisitResult, IGetResults
    {
        public CreateCodeVisitResult(Boolean successful, IReadOnlyList<ParserMessage> messages, TextMateGrammar.Grammar grammar)
        {
        ...
        private TextMateGrammar.Grammar _grammar;
    ...
    public ProcessNodeResult ProcessGrammarNode(Object context, ASTNode node, IList<ParserMessage> messages)
    {
        ...
        typedContext.Grammar = new TextMateGrammar.Grammar(definitions.ToList(), tmDefinitions.ToList(), options, typedContext.MessageContext, node);

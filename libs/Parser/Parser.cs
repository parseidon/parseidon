...
namespace Parseidon.Parser
{
    ...
    public class ParseResult
    {
        ...
        private ProcessNodeResult CallEvent(Object context, INodeVisitor visitor, Int32 tokenId, ASTNode node, IList<ParserMessage> messages)
        {
            switch (tokenId)
            {
                ...
                case 70: return visitor.ProcessDefinitionNode(context, node, messages);
                case 20: return visitor.ProcessDropNode(context, node, messages);
                case 68: return visitor.ProcessExpressionNode(context, node, messages);
                case 72: return visitor.ProcessGrammarNode(context, node, messages);
                ...
                case 66: return visitor.ProcessPrefixNode(context, node, messages);
                case 34: return visitor.ProcessRegexNode(context, node, messages);
                case 67: return visitor.ProcessSequenceNode(context, node, messages);
                case 65: return visitor.ProcessSuffixNode(context, node, messages);
                case 62: return visitor.ProcessTMDefinitionNode(context, node, messages);
                case 53: return visitor.ProcessTMIdentifierNode(context, node, messages);
                case 59: return visitor.ProcessTMIncludesNode(context, node, messages);
                case 57: return visitor.ProcessTMMatchNode(context, node, messages);
                case 58: return visitor.ProcessTMMatchSequenceNode(context, node, messages);
                case 56: return visitor.ProcessTMRegExNode(context, node, messages);
                case 54: return visitor.ProcessTMScopeNameNode(context, node, messages);
    ...
    public class ParseidonParser
    {
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(70, "Definition", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
                        (actualNode, errorName) => CheckRange(actualNode, state, errorName, 0, 1,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(68, "Expression", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(72, "Grammar", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule__(actualNode, state, errorName),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(71, "Option", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "@"),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(66, "Prefix", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRange(actualNode, state, errorName, 0, 1,
                        (actualNode, errorName) => CheckRule_Drop(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(67, "Sequence", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(65, "Suffix", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckOr(actualNode, state, errorName,
                        (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(62, "TMDefinition", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(59, "TMIncludes", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "["),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(57, "TMMatch", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule_Identifier(actualNode, state, errorName),
                    (actualNode, errorName) => CheckOr(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(58, "TMMatchSequence", "", state.Position);
            Boolean result =
                CheckOneOrMore(actualNode, state, errorName,
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(56, "TMRegEx", "", state.Position);
            Boolean result =
                MakeTerminal(actualNode, state, errorName, false,
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
                        (actualNode, errorName) => Drop(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(55, "TMRegExChar", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[^'\\\\]", 1),
                    (actualNode, errorName) => CheckOr(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(54, "TMScopeName", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule_TMIdentifier(actualNode, state, errorName),
                    (actualNode, errorName) => Drop(actualNode, state, errorName,

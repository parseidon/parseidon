...
namespace Parseidon.Parser
{
    ...
    public class ParseResult
    {
        ...
        private ProcessNodeResult CallEvent(Object context, INodeVisitor visitor, Int32 tokenId, ASTNode node, IList<ParserMessage> messages)
        {
            switch (tokenId)
            {
                ...
                case 31: return visitor.ProcessClassNameNode(context, node, messages);
                ...
                case 34: return visitor.ProcessGrammarNode(context, node, messages);
                ...
                case 32: return visitor.ProcessNamespaceNode(context, node, messages);
    ...
    public class ParseidonParser
    {
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(31, "ClassName", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckRule_Spacing(actualNode, state),
                    (actualNode) => CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(33, "Config", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(34, "Grammar", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(32, "Namespace", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckRule_Spacing(actualNode, state),
                    (actualNode) => CheckAnd(actualNode, state,

...
namespace Parseidon.Parser
{
    ...
    {
        ProcessNodeResult ProcessCSIdentifierNode(Object context, ASTNode node, IList<ParserMessage> messages);
    ...
    public class ParseResult
    {
        ...
        private ProcessNodeResult CallEvent(Object context, INodeVisitor visitor, Int32 tokenId, ASTNode node, IList<ParserMessage> messages)
        {
            switch (tokenId)
            {
                case 21: return visitor.ProcessCSIdentifierNode(context, node, messages);
    ...
    public class ParseidonParser
    {
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(20, "CSIdentCont", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(21, "CSIdentifier", "", state.Position);
            Boolean result =

...
namespace Parseidon.Parser
{
    ...
    public class ParseResult
    {
        ...
        private ProcessNodeResult CallEvent(Object context, INodeVisitor visitor, Int32 tokenId, ASTNode node, IList<ParserMessage> messages)
        {
            switch (tokenId)
            {
                ...
                case 37: return visitor.ProcessClassNameNode(context, node, messages);
                case 35: return visitor.ProcessDefinitionNode(context, node, messages);
                ...
                case 40: return visitor.ProcessGrammarNode(context, node, messages);
                ...
                case 38: return visitor.ProcessNamespaceNode(context, node, messages);
                ...
                case 36: return visitor.ProcessRootNodeNode(context, node, messages);
    ...
    public class ParseidonParser
    {
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(37, "ClassName", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckRule_Spacing(actualNode, state),
                    (actualNode) => CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(39, "Config", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(35, "Definition", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckRule_Spacing(actualNode, state),
                    (actualNode) => CheckAnd(actualNode, state,
                        (actualNode) => CheckRange(actualNode, state, 0, 1,
                            (actualNode) => CheckOr(actualNode, state,
                                ...
                                (actualNode) => CheckOr(actualNode, state,
                                    ...
                                    (actualNode) => CheckRule_TreatInline(actualNode, state)
                                )
                            )
                        ),
                        (actualNode) => CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(40, "Grammar", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(38, "Namespace", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckRule_Spacing(actualNode, state),
                    (actualNode) => CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(19, "Quantifier", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckText(actualNode, state, "{"),
                    (actualNode) => CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(36, "RootNode", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckRule_Spacing(actualNode, state),
                    (actualNode) => CheckAnd(actualNode, state,
        ...
        private Boolean CheckRule_TreatInline(ASTNode parentNode, ParserState state)
        {
            Int32 oldPosition = state.Position;

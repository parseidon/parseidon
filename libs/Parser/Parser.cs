...
namespace Parseidon.Parser
{
    ...
    public interface INodeVisitor : IVisitor
    {
        ...
        ProcessNodeResult ProcessTMRegExCharNode(Object context, ASTNode node, IList<ParserMessage> messages);
    ...
    public class ParseResult
    {
        ...
        private ProcessNodeResult CallEvent(Object context, INodeVisitor visitor, Int32 tokenId, ASTNode node, IList<ParserMessage> messages)
        {
            switch (tokenId)
            {
                case 25: return visitor.ProcessAllCharNode(context, node, messages);
                case 47: return visitor.ProcessBooleanNode(context, node, messages);
                case 44: return visitor.ProcessCSharpIdentifierNode(context, node, messages);
                case 33: return visitor.ProcessCharacterClassNode(context, node, messages);
                case 67: return visitor.ProcessDefinitionNode(context, node, messages);
                case 20: return visitor.ProcessDropNode(context, node, messages);
                case 65: return visitor.ProcessExpressionNode(context, node, messages);
                case 69: return visitor.ProcessGrammarNode(context, node, messages);
                case 42: return visitor.ProcessIdentifierNode(context, node, messages);
                case 19: return visitor.ProcessIsTerminalNode(context, node, messages);
                case 39: return visitor.ProcessLiteralNode(context, node, messages);
                case 48: return visitor.ProcessNumberNode(context, node, messages);
                case 21: return visitor.ProcessOneOrMoreNode(context, node, messages);
                case 23: return visitor.ProcessOptionalNode(context, node, messages);
                case 63: return visitor.ProcessPrefixNode(context, node, messages);
                case 34: return visitor.ProcessRegexNode(context, node, messages);
                case 64: return visitor.ProcessSequenceNode(context, node, messages);
                case 62: return visitor.ProcessSuffixNode(context, node, messages);
                case 59: return visitor.ProcessTMDefinitionNode(context, node, messages);
                case 53: return visitor.ProcessTMIdentifierNode(context, node, messages);
                case 58: return visitor.ProcessTMIncludesNode(context, node, messages);
                case 56: return visitor.ProcessTMMatchNode(context, node, messages);
                case 57: return visitor.ProcessTMMatchSequenceNode(context, node, messages);
                case 55: return visitor.ProcessTMRegExNode(context, node, messages);
                case 54: return visitor.ProcessTMRegExCharNode(context, node, messages);
                case 17: return visitor.ProcessTreatInlineNode(context, node, messages);
                case 16: return visitor.ProcessUseRuleNameAsErrorNode(context, node, messages);
                case 51: return visitor.ProcessValuePairNode(context, node, messages);
                case 22: return visitor.ProcessZeroOrMoreNode(context, node, messages);
            }
    ...
    public class ParseidonParser
    {
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(25, "AllChar", "", state.Position);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(47, "Boolean", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(43, "CSharpIdentCont", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(44, "CSharpIdentifier", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(36, "Char", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(33, "CharacterClass", "", state.Position);
            Boolean result =
                MakeTerminal(actualNode, state, errorName, false,
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
                        (actualNode, errorName) => CheckText(actualNode, state, errorName, "["),
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(31, "ClassContent", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state, errorName,
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(10, "Comment", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(67, "Definition", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
                        (actualNode, errorName) => CheckRange(actualNode, state, errorName, 0, 1,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(20, "Drop", "", state.Position);
            Boolean result =         CheckText(actualNode, state, errorName, "-");
            Int32 foundPosition = state.Position;
            if (result && ((actualNode.Children.Count > 0) || (actualNode.Text != "")))
                parentNode.AddChild(actualNode);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(35, "EscapeChars", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "\\"),
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(28, "EscapedChar", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "\\"),
                    (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[.\\\\\\[\\]\\-\\^]", 1)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(65, "Expression", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(69, "Grammar", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule__(actualNode, state, errorName),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(40, "IdentCont", "", state.Position);
            Boolean result =
                CheckZeroOrMore(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[a-zA-Z0-9]", 1)
                );
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(41, "IdentStart", "", state.Position);
            Boolean result =         CheckRegEx(actualNode, state, errorName, "[a-zA-Z]", 1);
            Int32 foundPosition = state.Position;
            if (result && ((actualNode.Children.Count > 0) || (actualNode.Text != "")))
                parentNode.AddChild(actualNode);
            return result;
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(42, "Identifier", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(19, "IsTerminal", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "$"),
                    (actualNode, errorName) => CheckRange(actualNode, state, errorName, 0, 1,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(39, "Literal", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(11, "NewLine", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(48, "Number", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(21, "OneOrMore", "", state.Position);
            Boolean result =         CheckText(actualNode, state, errorName, "+");
            Int32 foundPosition = state.Position;
            if (result && ((actualNode.Children.Count > 0) || (actualNode.Text != "")))
                parentNode.AddChild(actualNode);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(68, "Option", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "@"),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(23, "Optional", "", state.Position);
            Boolean result =         CheckText(actualNode, state, errorName, "?");
            Int32 foundPosition = state.Position;
            if (result && ((actualNode.Children.Count > 0) || (actualNode.Text != "")))
                parentNode.AddChild(actualNode);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(24, "Or", "", state.Position);
            Boolean result =         CheckText(actualNode, state, errorName, "/");
            Int32 foundPosition = state.Position;
            if (result && ((actualNode.Children.Count > 0) || (actualNode.Text != "")))
                parentNode.AddChild(actualNode);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(27, "PredefinedClass", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(63, "Prefix", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRange(actualNode, state, errorName, 0, 1,
                        (actualNode, errorName) => CheckRule_Drop(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(34, "Regex", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(64, "Sequence", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(29, "SingleChar", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[^\\\\\\[\\]\\-]", 1),
                    (actualNode, errorName) => CheckRule_UnicodeChars(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(62, "Suffix", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckOr(actualNode, state, errorName,
                        (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(59, "TMDefinition", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(52, "TMIdentCont", "", state.Position);
            Boolean result =
                CheckZeroOrMore(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[a-zA-Z0-9.\\-]", 1)
                );
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(53, "TMIdentifier", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(58, "TMIncludes", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "{"),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(56, "TMMatch", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule_Identifier(actualNode, state, errorName),
                    (actualNode, errorName) => CheckOr(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(57, "TMMatchSequence", "", state.Position);
            Boolean result =
                CheckOneOrMore(actualNode, state, errorName,
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(55, "TMRegEx", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => Drop(actualNode, state, errorName,
                        (actualNode, errorName) => CheckText(actualNode, state, errorName, "!'")
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(54, "TMRegExChar", "", state.Position);
            Boolean result =         CheckRegEx(actualNode, state, errorName, "[a-zA-Z]", 1);
            Int32 foundPosition = state.Position;
            if (result && ((actualNode.Children.Count > 0) || (actualNode.Text != "")))
                parentNode.AddChild(actualNode);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(17, "TreatInline", "", state.Position);
            Boolean result =         CheckText(actualNode, state, errorName, ":");
            Int32 foundPosition = state.Position;
            if (result && ((actualNode.Children.Count > 0) || (actualNode.Text != "")))
                parentNode.AddChild(actualNode);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(15, "UnicodeChars", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(16, "UseRuleNameAsError", "", state.Position);
            Boolean result =         CheckText(actualNode, state, errorName, "^");
            Int32 foundPosition = state.Position;
            if (result && ((actualNode.Children.Count > 0) || (actualNode.Text != "")))
                parentNode.AddChild(actualNode);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(51, "ValuePair", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule_Identifier(actualNode, state, errorName),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(12, "WhiteSpace", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(22, "ZeroOrMore", "", state.Position);
            Boolean result =         CheckText(actualNode, state, errorName, "*");
            Int32 foundPosition = state.Position;
            if (result && ((actualNode.Children.Count > 0) || (actualNode.Text != "")))
                parentNode.AddChild(actualNode);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(13, "_", "", state.Position);
            Boolean result =

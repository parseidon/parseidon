...
namespace Parseidon.Parser
{
    ...
    public interface INodeVisitor : IVisitor
    {
        ...
        ProcessNodeResult ProcessPromoteErrorNameNode(Object context, ASTNode node, IList<ParserMessage> messages);
    ...
    public class ParseResult
    {
        ...
        private ProcessNodeResult CallEvent(Object context, INodeVisitor visitor, Int32 tokenId, ASTNode node, IList<ParserMessage> messages)
        {
            switch (tokenId)
            {
                case 27: return visitor.ProcessCSharpIdentifierNode(context, node, messages);
                case 39: return visitor.ProcessClassNameNode(context, node, messages);
                case 37: return visitor.ProcessDefinitionNode(context, node, messages);
                case 7: return visitor.ProcessDotNode(context, node, messages);
                case 15: return visitor.ProcessDropNode(context, node, messages);
                case 35: return visitor.ProcessExpressionNode(context, node, messages);
                case 42: return visitor.ProcessGrammarNode(context, node, messages);
                case 30: return visitor.ProcessIdentifierNode(context, node, messages);
                case 14: return visitor.ProcessIsTerminalNode(context, node, messages);
                case 25: return visitor.ProcessLiteralNode(context, node, messages);
                case 40: return visitor.ProcessNamespaceNode(context, node, messages);
                case 3: return visitor.ProcessNumberNode(context, node, messages);
                case 16: return visitor.ProcessOneOrMoreNode(context, node, messages);
                case 18: return visitor.ProcessOptionalNode(context, node, messages);
                case 33: return visitor.ProcessPrefixNode(context, node, messages);
                case 31: return visitor.ProcessPrimaryNode(context, node, messages);
                case 12: return visitor.ProcessPromoteErrorNameNode(context, node, messages);
                case 23: return visitor.ProcessRegexNode(context, node, messages);
                case 22: return visitor.ProcessRegularExpressionNode(context, node, messages);
                case 38: return visitor.ProcessRootNodeNode(context, node, messages);
                case 34: return visitor.ProcessSequenceNode(context, node, messages);
                case 32: return visitor.ProcessSuffixNode(context, node, messages);
                case 13: return visitor.ProcessTreatInlineNode(context, node, messages);
                case 17: return visitor.ProcessZeroOrMoreNode(context, node, messages);
            }
    ...
    public class ParseidonParser
    {
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(21, "BracketContent", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(26, "CSharpIdentCont", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(27, "CSharpIdentifier", "", state.Position);
            Boolean result =
                PromoteErrorName(actualNode, state, "CSharpIdentifier",
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(24, "Char", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[^'\\\\]", 1),
                    (actualNode, errorName) => CheckOr(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(39, "ClassName", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(41, "Config", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(37, "Definition", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
                        (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
                            (actualNode, errorName) => CheckRange(actualNode, state, errorName, 0, 1,
                                (actualNode, errorName) => CheckRule_PromoteErrorName(actualNode, state, errorName)
                            ),
                            (actualNode, errorName) => CheckRange(actualNode, state, errorName, 0, 1,
                                (actualNode, errorName) => CheckOr(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(15, "Drop", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "-"),
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(35, "Expression", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(42, "Grammar", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(28, "IdentCont", "", state.Position);
            Boolean result =
                CheckZeroOrMore(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[a-zA-Z0-9_]", 1)
                );
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(29, "IdentStart", "", state.Position);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(30, "Identifier", "", state.Position);
            Boolean result =
                PromoteErrorName(actualNode, state, "Identifier",
                    (actualNode, errorName) => MakeTerminal(actualNode, state, errorName, false,
                        (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
                            (actualNode, errorName) => CheckRule_IdentStart(actualNode, state, errorName),
                            (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(14, "IsTerminal", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "$"),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        private Boolean CheckRule_LineEnd(ASTNode parentNode, ParserState state, String? errorName)
        {
            ...
            Boolean result =
                PromoteErrorName(actualNode, state, "LineEnd",
                    (actualNode, errorName) => Drop(actualNode, state, errorName,
                        (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
                            (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName),
                            (actualNode, errorName) => CheckText(actualNode, state, errorName, ";")
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(25, "Literal", "", state.Position);
            Boolean result =
                PromoteErrorName(actualNode, state, "Literal",
                    (actualNode, errorName) => MakeTerminal(actualNode, state, errorName, false,
                        (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
                            (actualNode, errorName) => CheckOr(actualNode, state, errorName,
                                (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(40, "Namespace", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        private Boolean CheckRule_NewLine(ASTNode parentNode, ParserState state, String? errorName)
        {
            ...
            Boolean result =
                PromoteErrorName(actualNode, state, "NewLine",
                    (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[\\r]", 1)
                );
            Int32 foundPosition = state.Position;
            if (result && ((actualNode.Children.Count > 0) || (actualNode.Text != "")))
                parentNode.AddChild(actualNode);
        ...
        private Boolean CheckRule_Number(ASTNode parentNode, ParserState state, String? errorName)
        {
            ...
            Boolean result =
                PromoteErrorName(actualNode, state, "Number",
                    (actualNode, errorName) => MakeTerminal(actualNode, state, errorName, false,
                        (actualNode, errorName) => CheckOr(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(16, "OneOrMore", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "+"),
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(18, "Optional", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "?"),
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(19, "Or", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "/"),
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(33, "Prefix", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRange(actualNode, state, errorName, 0, 1,
                        (actualNode, errorName) => CheckRule_Drop(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(31, "Primary", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule_Identifier(actualNode, state, errorName),
                    (actualNode, errorName) => CheckOr(actualNode, state, errorName,
        ...
        private Boolean CheckRule_PromoteErrorName(ASTNode parentNode, ParserState state, String? errorName)
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(12, "PromoteErrorName", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "^"),
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(23, "Regex", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(22, "RegularExpression", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(38, "RootNode", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(34, "Sequence", "", state.Position);
            Boolean result =
                CheckZeroOrMore(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(32, "Suffix", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
        ...
        private Boolean CheckRule_WhiteSpace(ASTNode parentNode, ParserState state, String? errorName)
        {
            ...
            Boolean result =
                PromoteErrorName(actualNode, state, "WhiteSpace",
                    (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[ \\t\\r\\n]", 1)
                );
            Int32 foundPosition = state.Position;
            if (result && ((actualNode.Children.Count > 0) || (actualNode.Text != "")))
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(17, "ZeroOrMore", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "*"),
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName)

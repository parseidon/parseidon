...
namespace Parseidon.Parser
{
    ...
    public class ParseResult
    {
        ...
        private ProcessNodeResult CallEvent(Object context, INodeVisitor visitor, Int32 tokenId, ASTNode node, IList<ParserMessage> messages)
        {
            switch (tokenId)
            {
                ...
                case 40: return visitor.ProcessCSharpIdentifierNode(context, node, messages);
                case 33: return visitor.ProcessCharacterClassNode(context, node, messages);
                case 55: return visitor.ProcessDefinitionNode(context, node, messages);
                case 12: return visitor.ProcessDotNode(context, node, messages);
                case 21: return visitor.ProcessDropNode(context, node, messages);
                case 48: return visitor.ProcessExpressionNode(context, node, messages);
                case 57: return visitor.ProcessGrammarNode(context, node, messages);
                case 43: return visitor.ProcessIdentifierNode(context, node, messages);
                case 20: return visitor.ProcessIsTerminalNode(context, node, messages);
                case 38: return visitor.ProcessLiteralNode(context, node, messages);
                case 8: return visitor.ProcessNumberNode(context, node, messages);
                case 22: return visitor.ProcessOneOrMoreNode(context, node, messages);
                case 24: return visitor.ProcessOptionalNode(context, node, messages);
                case 46: return visitor.ProcessPrefixNode(context, node, messages);
                case 52: return visitor.ProcessPropertyNode(context, node, messages);
                case 34: return visitor.ProcessRegexNode(context, node, messages);
                case 47: return visitor.ProcessSequenceNode(context, node, messages);
                case 45: return visitor.ProcessSuffixNode(context, node, messages);
                case 18: return visitor.ProcessTreatInlineNode(context, node, messages);
                case 17: return visitor.ProcessUseRuleNameAsErrorNode(context, node, messages);
                case 51: return visitor.ProcessValuePairNode(context, node, messages);
                case 23: return visitor.ProcessZeroOrMoreNode(context, node, messages);
            }
    ...
    public class ParseidonParser
    {
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(39, "CSharpIdentCont", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(40, "CSharpIdentifier", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(35, "Char", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(7, "Comment", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(55, "Definition", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(12, "Dot", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "."),
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(21, "Drop", "", state.Position);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(14, "Equal", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "="),
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(16, "EscapeChars", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "\\"),
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(48, "Expression", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(41, "IdentCont", "", state.Position);
            Boolean result =
                CheckZeroOrMore(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[a-zA-Z0-9_]", 1)
                );
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(42, "IdentStart", "", state.Position);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(43, "Identifier", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(20, "IsTerminal", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "$"),
                    (actualNode, errorName) => CheckRange(actualNode, state, errorName, 0, 1,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(13, "LineEnd", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(38, "Literal", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(9, "NewLine", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(8, "Number", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(22, "OneOrMore", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "+"),
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(56, "Option", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(24, "Optional", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "?"),
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(25, "Or", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "/"),
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(46, "Prefix", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRange(actualNode, state, errorName, 0, 1,
                        (actualNode, errorName) => CheckRule_Drop(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(52, "Property", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule_Identifier(actualNode, state, errorName),
                    (actualNode, errorName) => CheckRange(actualNode, state, errorName, 0, 1,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(47, "Sequence", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(11, "Spacing", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(45, "Suffix", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckOr(actualNode, state, errorName,
                        (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(18, "TreatInline", "", state.Position);
            Boolean result =         CheckText(actualNode, state, errorName, ":");
            Int32 foundPosition = state.Position;
            if (result && ((actualNode.Children.Count > 0) || (actualNode.Text != "")))
                parentNode.AddChild(actualNode);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(17, "UseRuleNameAsError", "", state.Position);
            Boolean result =         CheckText(actualNode, state, errorName, "^");
            Int32 foundPosition = state.Position;
            if (result && ((actualNode.Children.Count > 0) || (actualNode.Text != "")))
                parentNode.AddChild(actualNode);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(10, "WhiteSpace", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(23, "ZeroOrMore", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "*"),
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName)

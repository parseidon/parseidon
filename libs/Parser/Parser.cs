...
namespace Parseidon.Parser
{
    ...
    public sealed class ParseResult
    {
        ...
        private ProcessNodeResult CallEvent(Object context, INodeVisitor visitor, Int32 tokenId, ASTNode node, IList<ParserMessage> messages)
        {
            switch (tokenId)
            {
                ...
                case 49: return visitor.ProcessBooleanNode(context, node, messages);
                case 46: return visitor.ProcessCSharpIdentifierNode(context, node, messages);
                ...
                case 44: return visitor.ProcessIdentifierNode(context, node, messages);
                case 23: return visitor.ProcessIsTerminalNode(context, node, messages);
                case 41: return visitor.ProcessLiteralNode(context, node, messages);
                case 50: return visitor.ProcessNumberNode(context, node, messages);
                ...
                case 55: return visitor.ProcessTMIdentifierNode(context, node, messages);
                case 63: return visitor.ProcessTMIncludesNode(context, node, messages);
                case 60: return visitor.ProcessTMMatchNode(context, node, messages);
                case 61: return visitor.ProcessTMMatchSequenceNode(context, node, messages);
                case 59: return visitor.ProcessTMRegExNode(context, node, messages);
                case 57: return visitor.ProcessTMScopeNameNode(context, node, messages);
                ...
                case 53: return visitor.ProcessValuePairNode(context, node, messages);
    ...
    public sealed class ParseidonParser
    {
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(49, "Boolean", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(46, "CSharpIdentifier", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(44, "Identifier", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(41, "Literal", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(50, "Number", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(55, "TMIdentifier", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(60, "TMMatch", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state, errorName,
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
                        (actualNode, errorName) => CheckRange(actualNode, state, errorName, 0, 1,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(61, "TMMatchSequence", "", state.Position);
            Boolean result =
                CheckOneOrMore(actualNode, state, errorName,
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(59, "TMRegEx", "", state.Position);
            Boolean result =
                MakeTerminal(actualNode, state, errorName, false,
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
                        (actualNode, errorName) => Drop(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(58, "TMRegExChar", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[^'\\\\]", 1),
                    (actualNode, errorName) => CheckOr(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(57, "TMScopeName", "", state.Position);
            Boolean result =
                MakeTerminal(actualNode, state, errorName, false,
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
                        (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[a-zA-Z]", 1),
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(53, "ValuePair", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckDefinition_Identifier(actualNode, state, errorName),
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,

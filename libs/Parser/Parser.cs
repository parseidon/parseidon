...
namespace Parseidon.Parser
{
    ...
    public class ParseResult
    {
        ...
        private ProcessNodeResult CallEvent(Object context, INodeVisitor visitor, Int32 tokenId, ASTNode node, IList<ParserMessage> messages)
        {
            switch (tokenId)
            {
                case 23: return visitor.ProcessCSharpIdentifierNode(context, node, messages);
                case 34: return visitor.ProcessClassNameNode(context, node, messages);
                case 32: return visitor.ProcessDefinitionNode(context, node, messages);
                case 7: return visitor.ProcessDotNode(context, node, messages);
                case 12: return visitor.ProcessDropNode(context, node, messages);
                case 31: return visitor.ProcessExpressionNode(context, node, messages);
                case 37: return visitor.ProcessGrammarNode(context, node, messages);
                case 26: return visitor.ProcessIdentifierNode(context, node, messages);
                case 11: return visitor.ProcessIsTerminalNode(context, node, messages);
                case 21: return visitor.ProcessLiteralNode(context, node, messages);
                case 35: return visitor.ProcessNamespaceNode(context, node, messages);
                case 13: return visitor.ProcessOneOrMoreNode(context, node, messages);
                case 15: return visitor.ProcessOptionalNode(context, node, messages);
                case 29: return visitor.ProcessPrefixNode(context, node, messages);
                case 27: return visitor.ProcessPrimaryNode(context, node, messages);
                case 19: return visitor.ProcessRegexNode(context, node, messages);
                case 33: return visitor.ProcessRootNodeNode(context, node, messages);
                case 30: return visitor.ProcessSequenceNode(context, node, messages);
                case 28: return visitor.ProcessSuffixNode(context, node, messages);
                case 14: return visitor.ProcessZeroOrMoreNode(context, node, messages);
            }
    ...
    public class ParseidonParser
    {
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(18, "BracketContent", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(22, "CSharpIdentCont", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(23, "CSharpIdentifier", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(20, "Char", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state,
                    (actualNode) => CheckRegEx(actualNode, state, "[^'\\\\]"),
                    (actualNode) => CheckOr(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(34, "ClassName", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckRule_Spacing(actualNode, state),
                    (actualNode) => CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(36, "Config", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(32, "Definition", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckRule_Spacing(actualNode, state),
                    (actualNode) => CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(12, "Drop", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckText(actualNode, state, "-"),
                    (actualNode) => CheckRule_Spacing(actualNode, state)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(10, "EscapeChars", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(31, "Expression", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(37, "Grammar", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(24, "IdentCont", "", state.Position);
            Boolean result =
                CheckZeroOrMore(actualNode, state,
                    (actualNode) => CheckRegEx(actualNode, state, "[a-zA-Z0-9_]")
                );
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(25, "IdentStart", "", state.Position);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(26, "Identifier", "", state.Position);
            Boolean result =
                MakeTerminal(actualNode, state,
                    (actualNode) => CheckAnd(actualNode, state,
                        (actualNode) => CheckRule_IdentStart(actualNode, state),
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(11, "IsTerminal", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckText(actualNode, state, "$"),
                    (actualNode) => CheckRule_Spacing(actualNode, state)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(21, "Literal", "", state.Position);
            Boolean result =
                MakeTerminal(actualNode, state,
                    (actualNode) => CheckAnd(actualNode, state,
                        (actualNode) => CheckOr(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(35, "Namespace", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckRule_Spacing(actualNode, state),
                    (actualNode) => CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(13, "OneOrMore", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckText(actualNode, state, "+"),
                    (actualNode) => CheckRule_Spacing(actualNode, state)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(15, "Optional", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckText(actualNode, state, "?"),
                    (actualNode) => CheckRule_Spacing(actualNode, state)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(16, "Or", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckText(actualNode, state, "/"),
                    (actualNode) => CheckRule_Spacing(actualNode, state)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(29, "Prefix", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckRange(actualNode, state, 0, 1,
                        (actualNode) => CheckRule_Drop(actualNode, state)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(27, "Primary", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state,
                    (actualNode) => CheckRule_Identifier(actualNode, state),
                    (actualNode) => CheckOr(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(17, "Quantifier", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckText(actualNode, state, "{"),
                    (actualNode) => CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(19, "Regex", "", state.Position);
            Boolean result =
                MakeTerminal(actualNode, state,
                    (actualNode) => CheckAnd(actualNode, state,
                        (actualNode) => CheckText(actualNode, state, "["),
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(33, "RootNode", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckRule_Spacing(actualNode, state),
                    (actualNode) => CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(30, "Sequence", "", state.Position);
            Boolean result =
                CheckZeroOrMore(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(28, "Suffix", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(14, "ZeroOrMore", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state,
                    (actualNode) => CheckText(actualNode, state, "*"),
                    (actualNode) => CheckRule_Spacing(actualNode, state)

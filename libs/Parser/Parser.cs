...
namespace Parseidon.Parser
{
    ...
    public class ParseResult
    {
        ...
        private ProcessNodeResult CallEvent(Object context, INodeVisitor visitor, Int32 tokenId, ASTNode node, IList<ParserMessage> messages)
        {
            switch (tokenId)
            {
                ...
                case 35: return visitor.ProcessCharacterClassNode(context, node, messages);
                case 57: return visitor.ProcessDefinitionNode(context, node, messages);
                case 14: return visitor.ProcessDotNode(context, node, messages);
                case 23: return visitor.ProcessDropNode(context, node, messages);
                case 50: return visitor.ProcessExpressionNode(context, node, messages);
                ...
                case 40: return visitor.ProcessLiteralNode(context, node, messages);
                case 10: return visitor.ProcessNumberNode(context, node, messages);
                ...
                case 48: return visitor.ProcessPrefixNode(context, node, messages);
                case 54: return visitor.ProcessPropertyNode(context, node, messages);
                case 36: return visitor.ProcessRegexNode(context, node, messages);
                case 49: return visitor.ProcessSequenceNode(context, node, messages);
                case 47: return visitor.ProcessSuffixNode(context, node, messages);
    ...
    public class ParseidonParser
    {
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(37, "Char", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(35, "CharacterClass", "", state.Position);
            Boolean result =
                MakeTerminal(actualNode, state, errorName, false,
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
                        (actualNode, errorName) => CheckText(actualNode, state, errorName, "["),
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(33, "ClassContent", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state, errorName,
                    (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(9, "Comment", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(14, "Dot", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "."),
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(16, "Equal", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "="),
                    (actualNode, errorName) => CheckRule_Spacing(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(18, "EscapeChars", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "\\"),
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(30, "EscapedChar", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckText(actualNode, state, errorName, "\\"),
                    (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[.\\\\\\[\\]\\-\\^]", 1)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(50, "Expression", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(43, "IdentCont", "", state.Position);
            Boolean result =
                CheckZeroOrMore(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[a-zA-Z0-9_]", 1)
                );
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(44, "IdentStart", "", state.Position);
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(15, "LineEnd", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(40, "Literal", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(10, "Number", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(29, "PredefinedClass", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(48, "Prefix", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRange(actualNode, state, errorName, 0, 1,
                        (actualNode, errorName) => CheckRule_Drop(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(54, "Property", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRule_Identifier(actualNode, state, errorName),
                    (actualNode, errorName) => CheckRange(actualNode, state, errorName, 0, 1,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(36, "Regex", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(49, "Sequence", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(31, "SingleChar", "", state.Position);
            Boolean result =
                CheckOr(actualNode, state, errorName,
                    (actualNode, errorName) => CheckRegEx(actualNode, state, errorName, "[^\\\\\\[\\]\\-]", 1),
                    (actualNode, errorName) => CheckRule_UnicodeChars(actualNode, state, errorName)
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(13, "Spacing", "", state.Position);
            Boolean result =
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(47, "Suffix", "", state.Position);
            Boolean result =
                CheckAnd(actualNode, state, errorName,
                    (actualNode, errorName) => CheckOr(actualNode, state, errorName,
                        (actualNode, errorName) => CheckAnd(actualNode, state, errorName,
        ...
        {
            Int32 oldPosition = state.Position;
            ASTNode actualNode = new ASTNode(17, "UnicodeChars", "", state.Position);
            Boolean result =

...
{
    public OrOperator(AbstractDefinitionElement? left, AbstractDefinitionElement? right, Func<Int32, (UInt32, UInt32)> calcLocation, ASTNode node) : base(left, right, calcLocation, node) { }
